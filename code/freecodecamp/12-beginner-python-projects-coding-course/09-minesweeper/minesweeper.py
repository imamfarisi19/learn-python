...
class Board: 
    def __init__(self, dim_size, num_bombs):
        # let's keep track of these prameters. they'll be helpful later 
        ...
        self.dug = set() # if we dit at 0, 0, then self.dug = {(0,0)}
    ...
    def dig(self, row, col): 
        ...
        # dig at location wit hno neighboring bombs - recursively dig neighbors! 
...
def play(dim_size=10, num_bombs=10): 
    ...
    # Step 3b: if location is not a bomb, dig recursively untill each square is at least 
    #          next to a bomb 
    # Step 4: repeat steps 2 and 3a/b untill there are no more places to dig -> VICTORY 
    safe = True
